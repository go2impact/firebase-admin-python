...
import requests
from google.auth import credentials, iam, jwt, transport

from firebase_admin import _auth_utils, _http_client, exceptions
...
ALGORITHM_NONE = "none"
DEFAULT_CLOCK_SKEW_IN_SECONDS = 10
...
class TokenVerifier:
    ...
    def __init__(self, app):
        ...
        clock_skew_in_seconds = app.options.get(
            "clockSkewInSeconds", DEFAULT_CLOCK_SKEW_IN_SECONDS
        )
...
class _JWTVerifier:
    ...
    def __init__(self, **kwargs):
        ...
        self._clock_skew_in_seconds = kwargs.pop(
            "clock_skew_in_seconds", DEFAULT_CLOCK_SKEW_IN_SECONDS
        )
